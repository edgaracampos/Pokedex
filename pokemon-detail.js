...
function setElementStyles(elements, ccsProperty, value) {
    elements.forEach((element) => {
        element.style[ccsProperty] = value;
    });
}
...
function setTypeBackgroundColor(pokemon) {
    ...
    setElementStyles(document.querySelectorAll('.power-wrapper > p'), 'backgroundColor');
    setElementStyles(document.querySelectorAll('.stats-wrap p.stats'), 'color');
    setElementStyles(document.querySelectorAll('.stats-wrap .progress-bar'), 'color');
